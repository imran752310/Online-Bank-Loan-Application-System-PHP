    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Rejected Loan customer</h5>
              ...
              <table class="table">
				...
				<?php
				$query1="select * from apply_loan_table where status ='3'";
                ...
                <tbody>
                  <tr>
                    <td><?php
						...
						?></td>
						<td><a  href="#" class="btn btn-danger btn-block btn-sm">Rejected</a></td>
						</tr>
						<?php
						}
