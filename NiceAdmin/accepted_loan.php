    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Accepted Loan customer</h5>
              <!-- Default Table -->
              <table class="table">
                <thead>
                  <tr>
				...
				<?php
				$query1="select * from apply_loan_table where status ='2'";
                ...
                <tbody>
                  <tr>
                    <td><?php
						...
						?></td>
						<td><a  href="#" class="btn btn-info btn-block btn-sm">Accepted</a></td>
						</tr>
						<?php
						}
						?>	
